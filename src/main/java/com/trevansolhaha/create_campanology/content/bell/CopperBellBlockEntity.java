...
public class CopperBellBlockEntity extends SmartBlockEntity implements GeoBlockEntity, IHaveGoggleInformation {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    protected static final RawAnimation CLICK_ANIMATION = RawAnimation.begin().thenPlay("copper_bell_1.swing");
