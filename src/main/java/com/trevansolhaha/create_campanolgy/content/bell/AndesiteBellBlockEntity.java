...
public class AndesiteBellBlockEntity extends SmartBlockEntity implements GeoBlockEntity, IHaveGoggleInformation {
    ...
    protected static final RawAnimation CLICK_ANIMATION = RawAnimation.begin().thenPlay("andesite_alloy_bell_1.swing");
    public AndesiteBellBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ANDESITE_ALLOY_BELL.get(), pos, state);
    }
